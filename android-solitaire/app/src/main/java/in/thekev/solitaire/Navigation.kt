...
import `in`.thekev.solitaire.TodoScreens.ADD_EDIT_TASK_SCREEN
import `in`.thekev.solitaire.TodoScreens.STATISTICS_SCREEN
import `in`.thekev.solitaire.TodoScreens.TASKS_SCREEN
import `in`.thekev.solitaire.TodoScreens.TASK_DETAIL_SCREEN
